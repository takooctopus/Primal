# https://github.com/Devaniti/GetDXC
# GetDXC.bat PathToFolder or powershell -ExecutionPolicy Bypass -File GetDXC.ps1 PathToFolder
...
if(Test-Path $SaveFolder\*){
	Write-Host "Target path is not empty. Delete it to redownload the latest DXC version."
	exit 0
}
