...
namespace PrimalEditor.Editors
{
    ...
    /// <summary>
    /// 暂时没有我们自己的渲染器，用这个类来暂时用一用wpf的渲染
    /// </summary>
    /// <seealso cref="PrimalEditor.ViewModelBase" />
    internal class MeshRendererVertexData : ViewModelBase
    {
    ...
    /// <summary>
    /// 因为我们现在没有渲染器，所以用这个wpf代替
    /// </summary>
    internal class MeshRenderer : ViewModelBase
    {
        ...
        public Color GroundLightLight
        {
            ...
            set
            {
                ...
                {
                    _groundLight = value;
                    OnPropertyChanged(nameof(GroundLightLight));
                }
            }
        }
        ...
        public MeshRenderer(Content.MeshLOD lod, MeshRenderer old)
        {
            ...
            // calculate vertex size - the position and normal vectors
